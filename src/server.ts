/**
 * Plugin entry: `export default { id, setup }` — the plain object form the loader accepts, with no
 * runtime import of `@opencode/plugin` (it is a types-only devDependency).
 *
